...
# Segurança
SECRET_KEY = 'sua_chave_secreta_aqui'  # troque por uma chave segura
DEBUG = True  # coloque False apenas em produção
...
# Arquivos estáticos
STATIC_URL = '/static/'
#STATICFILES_DIRS = [BASE_DIR / 'static']  # se você tiver pasta static
